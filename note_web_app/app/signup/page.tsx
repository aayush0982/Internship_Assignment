  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!showOTPInput) {
      ...
      setFormData({
        ...
        dob: formDataObj.get('dob') as string,
        email: email,
    ...
    <div className="min-h-screen flex flex-col md:flex-row items-center justify-center bg-white relative">
      ...
      <div className="flex flex-1 flex-col justify-center items-center py-12 px-6">
        <div className="w-full max-w-md rounded-lg p-8">
          <h1 className="text-[40px] font-bold text-center md:text-left">Sign up</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              />
              {state?.error?.dob && (
                <p className="text-red-500 text-sm">{state.error.dob[0]}</p>
              )}
            </div>
